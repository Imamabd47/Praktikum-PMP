 ...
 *   Nama File           : soal1.c
 *   Deskripsi           : Merupakan Sebuah Program untuk Memvalidasi Kode Spesial dengan 4 aturan validasi
 * 
 */
